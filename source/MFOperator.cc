...
template <int dim, int fe_degree, int n_q_points_1d, typename number>
void
MFOperator<dim,fe_degree,n_q_points_1d,number>::reinit (const dealii::DoFHandler<dim>  *dof_handler_,
...
template <int dim, int fe_degree, int n_q_points_1d, typename number>
void
MFOperator<dim,fe_degree,n_q_points_1d,number>::vmult (LA::MPI::Vector       &dst,
...
template <int dim, int fe_degree, int n_q_points_1d, typename number>
void
MFOperator<dim,fe_degree,n_q_points_1d,number>::vmult_add (LA::MPI::Vector       &dst,
                                                           const LA::MPI::Vector &src) const
{
...
template <int dim, int fe_degree, int n_q_points_1d, typename number>
void
MFOperator<dim,fe_degree,n_q_points_1d,number>::Tvmult (LA::MPI::Vector       &dst,
                                                        const LA::MPI::Vector &src) const
{
  dst = 0;
  dst.compress(dealii::VectorOperation::insert);
...
template <int dim, int fe_degree, int n_q_points_1d, typename number>
void
MFOperator<dim,fe_degree,n_q_points_1d,number>::Tvmult_add (LA::MPI::Vector       &dst,
                                                            const LA::MPI::Vector &src) const
{
  vmult_add(dst, src);
}
...
template <int dim, int fe_degree, int n_q_points_1d, typename number>
void
MFOperator<dim,fe_degree,n_q_points_1d,number>::initialize_dof_vector (LA::MPI::Vector &vector) const
{
...
template <int dim, int fe_degree, int n_q_points_1d, typename number>
void
MFOperator<dim,fe_degree,n_q_points_1d,number>::set_timer (dealii::TimerOutput &timer_)
{
  timer = &timer_;
}
